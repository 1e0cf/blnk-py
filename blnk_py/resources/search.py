...
class SearchResource:
    def __init__(self, http: AsyncHttp):
        self._http = http
    async def transactions(self, *, q: str = '*', query_by: str = 'reference', filter_by: str | None = None, per_page: int = 50) -> Dict[str, Any]:
        payload = {'q': q, 'query_by': query_by, 'per_page': per_page}
        if filter_by:
